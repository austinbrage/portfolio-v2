...
export class ExperienceController {
  ...
  async render(context: any, experienceId: number) {
    try {
      ...
      return "Error loading experience page";
    }
  }
  ...
  public async warmupCache() {
    if (!this.isDev) {
      console.log("Warming up experience cache...");
      await this.getTemplate();
      await this.getRenderer(this.cache.template!);
      console.log("experience cache warmed up ✓");
    }
  }
